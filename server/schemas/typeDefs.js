...
type Query {
  ...
  type Query {
    ...
    events: [Event!]
    event(id: ID!): Event
    getMessages(plannerId: ID!, clientId: ID!): [Message!]   # Add this line
  }
...
type Mutation {
  sendMessage(senderId: ID!, senderModel: String!, receiverId: ID!, receiverModel: String!, eventId: ID!, content: String!): Message
}
